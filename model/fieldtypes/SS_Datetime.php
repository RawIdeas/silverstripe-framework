 ...
 * @deprecated 4.0.0:5.0.0 Use DBDatetime instead.
 */
class SS_Datetime extends DBDatetime {
	...
	protected static function deprecation_notice() {
		Deprecation::notice('4.0', 'SS_Datetime is deprecated. Please use DBDatetime instead.');
	}
}